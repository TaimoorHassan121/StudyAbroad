...
namespace Study_Abroad.Controllers
{
   // [Authorize(Roles = "Agent")]
    public class CitiesController : Controller
    {
        ...
        public CitiesController(StudyAbroadContext context)
        {
            _context = context;
        }
        ...
        {
            var studyAbroadContext = _context.Cities.Include(c => c.States).Include(c => c.country);
        ...
        public async Task<IActionResult> Create([Bind("CityId,CountryId,StateId,CityName,Status,DateTime")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,CountryId,StateId,CityName,Status,DateTime")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
