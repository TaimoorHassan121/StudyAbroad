...
namespace Study_Abroad.Migrations
{
    ...
    [Migration("20230921144100_Study Abroad")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Study_Abroad.Models.AppRequairement", b =>
                {
                    ...
                    b.Property<string>("Addational_Document")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("Additional_Status")
                        .HasColumnType("bit");

                    b.Property<string>("Bank_Statement")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Emergency_Email")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Medical_Statement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("Medical_Status")
                        .HasColumnType("bit");

                    b.Property<bool>("Passport_Status")
                        .HasColumnType("bit");

                    b.Property<string>("Passportpic")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Personal_Statement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("Personal_Status")
                        .HasColumnType("bit");

                    b.Property<string>("Privacy_Statement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("Privacy_Status")
                        .HasColumnType("bit");

                    b.Property<string>("Refree_Address")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Refree_Conteat")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Refree_Email")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Refree_Name")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ReqId");

                    b.ToTable("Requairement");
                });
            ...
            modelBuilder.Entity("Study_Abroad.Models.ApplicationDetails", b =>
                {
                    ...
                    b.Property<int?>("RequairementReqId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Study_Abroad.Models.Assessment", b =>
                {
                    ...
                    b.Property<string>("CountryOfInterest")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LanguageCertification")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UniversityOfInterest")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Study_Abroad.Models.AssessmentEducationalBackground", b =>
                {
                    b.Property<long>("AssessmentEducationalBackgroundId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("GraduatingYear")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("AssessmentEducationalBackgroundId");

                    b.HasIndex("AssessmentId");

                    b.ToTable("AssessmentEducationalBackgrounds");
                });
            ...
            modelBuilder.Entity("Study_Abroad.Models.ApplicationDetails", b =>
                {
                    ...
                    b.HasOne("Study_Abroad.Models.AppRequairement", "Requairement")
                        .WithMany()
                        .HasForeignKey("RequairementReqId");
            ...
            modelBuilder.Entity("Study_Abroad.Models.AssessmentEducationalBackground", b =>
                {
                    b.HasOne("Study_Abroad.Models.Assessment", "Assessment")
                        .WithMany()
            ...
            modelBuilder.Entity("Study_Abroad.Models.StudentProfile", b =>
                {
                    b.HasOne("Study_Abroad.Models.Agent", "agent")
                        .WithMany()
